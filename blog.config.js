...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的废柴', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://huiyouyuan.netlify.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '会有缘的博客', // 网站关键词 英文逗号隔开
